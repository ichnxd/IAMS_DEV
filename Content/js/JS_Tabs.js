app.directive('jstab', ['$rootScope', '$state', '$timeout', 'JSDataService', '$controller', '$compile', 'CacheFactory', '$base64', 'JsPopUpView',
function ($rootScope, $state, $timeout, JSDataService, $controller, $compile, CacheFactory, $base64, JsPopUpView) {
    return {
        restrict: 'E',
        transclude: true,
        scope: {
        ...
        link: function ($scope, element, attrs) {
            ...
            var InitView = function (tab, View, ID_ViewType, CurrentObject, Params) {
                ...
                var viewControllerInitialized = function () {
                    ...
                    //
                    //
                    var ShowInvalidAccess = function () {
...
//                        console.log('VIEW ACCESS',View);
            ...
            var _contextMenus = [ { id: 1, text: 'Close', icon: 'fa fa-close' },
                         { id: 2, text: 'Close others', icon: 'mdi mdi-close-box' },
                         { id: 3, text: 'Close All', icon: 'mdi mdi-close-box-outline' },
                         {
            ...
            $scope.dxContextMenu = {
                ...
                onItemClick: function (e) {
                    ...
                    var CurrentTab = Enumerable.From($scope.tabs).Where(t => t.id === tabID).SingleOrDefault();
                    ...
                    switch (e.itemData.id) {
                        case 1:
                            ...
                            break;
                        case 2:
                            var Tabs = Enumerable.From($scope.tabs).Where(t => t.id !== tabID).ToArray();
