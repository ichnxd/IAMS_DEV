app.controller('LoginController', ['$scope', '$http', '$location', 'JsPopUpView', 'JSDataService', 'JsWizardView', 'CacheFactory',
    function ($scope, $http, $location, JsPopUpView, JSDataService, JsWizardView, CacheFactory) {
