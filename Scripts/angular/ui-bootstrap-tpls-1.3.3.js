  ...
  function($modalStack, $q, $animateCss, $document) {
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        scope.dialogWidth = attrs.dialogwidth;
        ...
        removeAfterAnimate(modalWindow.modalDomEl, modalWindow.modalScope, function() {
          ...
          if (!areAnyOpen && scrollbarPadding && scrollbarPadding.heightOverflow && scrollbarPadding.scrollbarWidth) {
            if (scrollbarPadding.originalRight) {
                ...
                appendToElement.css({ paddingRight: 0 + 'px' });
            } else {
            ...
            samePromise = promiseChain = $q.all([promiseChain])
              ...
              .then(function resolveSuccess(tplAndVars) {
                ...
                $modalStack.open(modalInstance, {
                  ...
                  dialogWidth : modalOptions.dialogWidth,
...
angular.module("uib/template/modal/window.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/modal/window.html",
    ...
    "    <div class=\"modal-dialog {{size ? 'modal-' + size : ''}}\" style=\"width:{{dialogWidth}}\">{{dialogWidth}}<div class=\"modal-content\" uib-modal-transclude></div></div>\n" +
    "</div>\n" +
    "");
}]);
